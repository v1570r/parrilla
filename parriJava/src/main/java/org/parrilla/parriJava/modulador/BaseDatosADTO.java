...
public class BaseDatosADTO {
    ...
    public static ProgramaDTO transformarAProgramaDTODesdeTablaCalendario(TablaCalendario programa){
        ...
        return new ProgramaDTO(
                ...
                null == programa.getOrden() ? null :OrdenDTO.valueOf(programa.getOrden()),
                null == programa.getRepetir() ? null : RepetirDTO.valueOf(programa.getRepetir()),
                programa.getRepetir_cada(),
                dias_de_la_semana,
                null == programa.getCoincidencia() ? null : CoincidenciaDTO.valueOf(programa.getCoincidencia()),
                null == programa.getDuracion() ? null : DuracionDTO.valueOf(programa.getDuracion()),
